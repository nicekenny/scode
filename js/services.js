...
function doBuy(a) {
	...
	var tpwd_html = "<div class=\"tao_pwd\">"
		...
		+"<div class=\"item_qrcode\" style=\"display:none;\"><img src=\"http://qr.liantu.com/api.php?bg=f3f3f3&el=l&w=200&m=8&text="+encodeURIComponent(buyUrl)+"\" style=\"width:160px;height:160px;\"/></div>"
